"""Unitree Go2 robot constants and articulation configuration."""
...
GO2_XML: Path = (
  MJLAB_SRC_PATH / "asset_zoo" / "robots" / "unitree_go2" / "xml" / "go2.xml"
)
...
# Rotor inertia.
# Ref: https://github.com/unitreerobotics/unitree_ros/blob/master/robots/go2_description/urdf/go2.urdf#L515
...
INIT_STATE = EntityCfg.InitialStateCfg(
  pos=(0.011446828, 0.0013224714, 0.32019413),
  rot=(0.98161817, -0.07083439, 0.018239634, 0.17628275),
  joint_pos={
    "FL_hip_joint": -0.2685233,
    "FL_thigh_joint": -0.18719791,
    "FL_calf_joint": -0.8383993,
    "FR_hip_joint": 0.45251113,
    "FR_thigh_joint": 0.6864915,
    "FR_calf_joint": -1.4168774,
    "RL_hip_joint": -0.1301512,
    "RL_thigh_joint": 0.8982419,
    "RL_calf_joint": -1.1499609,
    "RR_hip_joint": 0.2014172,
    "RR_thigh_joint": 1.0143824,
    "RR_calf_joint": -1.3094097,
  },
  joint_vel={".*": 0.0},
)
